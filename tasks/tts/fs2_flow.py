...
from modules.fastspeech.fs2_flow import FastSpeech2Flow


class FastSpeech2FlowTask(TtsTask):
    def __init__(self):
        super(FastSpeech2FlowTask, self).__init__()
    ...
    def build_tts_model(self):
        self.model = FastSpeech2Flow(self.phone_encoder)
